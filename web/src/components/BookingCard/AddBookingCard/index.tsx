...
import { Plus, X, Save, Calendar, Users, CreditCard, MapPin, Ship, FileText } from 'lucide-react';
...
interface AddBookingCardProps {
  onBookingAdded: () => void;
  buttonText?: string;
  className?: string;
}

const AddBookingCard: React.FC<AddBookingCardProps> = ({
  onBookingAdded,
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                ...
                >
                  ...
                  <span>{isLoading ? 'Creating...' : 'Create Booking'}</span>
                </button>
              </div>
            </form>
          </div>
