...
import { Plus, X, Navigation, Save, MapPin, Clock, DollarSign, CheckCircle } from 'lucide-react';
...
const AddRouteCard: React.FC<AddRouteCardProps> = ({
  onRouteAdded,
  ...
  const validateForm = () => {
    ...
    if (formData.departurePortId && formData.arrivalPortId && 
        formData.departurePortId === formData.arrivalPortId) {
  ...
  if (!isModalOpen) {
    return (
      <button
        onClick={openModal}
        className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors ${buttonClassName}`}
      >
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900">Add New Route</h3>
              <p className="text-sm text-gray-500">Create a new ferry route between ports</p>
            </div>
          </div>
          <button
            onClick={closeModal}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter route name (e.g., Jakarta - Bali Express)"
              disabled={loading}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-500">
                Base price for passengers (maximum $10,000)
              </p>
