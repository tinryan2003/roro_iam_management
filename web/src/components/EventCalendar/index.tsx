  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-md">
      ...
      <div className="flex flex-col gap-4">
        {events.map((event) => (
          <div
            className="p-5 rounded-md border-2 border-gray-100 dark:border-gray-700 border-t-4 odd:border-t-lamaSky even:border-t-lamaPurple bg-white dark:bg-gray-800"
            key={event.id}
          >
            <div className="flex items-center justify-between">
